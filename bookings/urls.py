...
from .views import stripe_checkout, success, stripe_webhook, my_bookings, cancel_booking, edit_booking_additional_notes
...
urlpatterns = [
    ...
    path('book/<int:booking_id>/edit/', edit_booking_additional_notes, name='edit_booking_additional_notes'),
